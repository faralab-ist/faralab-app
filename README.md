...
# Contributing to Faralab

Thank you for your interest in contributing to **Faralab**!  
This is an academic open-source project developed at the **Instituto Superior Técnico (IST)**.  
We welcome contributions from students, educators, and researchers who wish to improve or extend the platform.
...
# Academic Open Collaboration License (AOCL) v1.0

Copyright (c) 2025 Faralab Dev Team

Permission is hereby granted, free of charge, to any academic, educational, or research institution obtaining a copy of this software and associated documentation files (the “Software”), to use, copy, modify, and distribute the Software for academic and research purposes, subject to the following conditions:

1. **Attribution** – The authors and institution must be explicitly acknowledged in any distribution, modification, or derived work.  
2. **Academic Use Only** – Commercial use of the Software, in whole or in part, is strictly prohibited without written authorization from the authors.  
3. **Open Modifications** – Any modified version must be made available under the same terms as this license.  
4. **Derivative Licensing** – Derivative works must remain under the AOCL v1.0 license.  
5. **Citation** – Publications or academic works using this software must cite *Faralab* and the original authors.  
6. **Patent Protection** – No contributor or licensee may claim patent rights over the Software or its derivatives.  
