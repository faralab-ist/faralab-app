...
export default function getFieldVectors3(chargedObjects, gridSize=10, step=1, onlyGaussianField=false, 
        ...
        if (lateralCount > 0) {
          ...
          for (let ri = 0; ri < rows && gridVector3.length < sampleCount; ri++) {
            for (let ci = 0; ci < cols && gridVector3.length < sampleCount; ci++) {
              ...
              gridVector3.push(new THREE.Vector3(
