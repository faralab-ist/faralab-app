...
export default function Sidebar({ 
  ...
  const pillObjects = (objects || []).filter(o => ['path', 'charge', 'testPointCharge','wire', 'plane', 'surface','chargedSphere', 'stackedPlanes', 'concentricSpheres', 'concentricInfWires', 'coil'].includes(o.type));
  const typeCounters = {};
