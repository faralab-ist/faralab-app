...
export default function FieldArrows({
  ...
  const vectorsUnfiltered = useMemo(
    () => {
      // Align param order with getFieldVector3 signature: (objects, gridSize, step, showOnlyPlane, showOnlyElectricField, minThreshold, planeFilter)
      const vecs = getFieldVector3(objects, gridSize, step, false, showOnlyGaussianField, minThreshold, planeFilter)
